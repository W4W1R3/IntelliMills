        ...
        setContentView(R.layout.activity_registerfarm);
            ...
            submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   reference = rootNode2.getReference("FarmS Registered");
                    ...
                    if (TextUtils.isEmpty(emails)) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                FarmsRegisteredClass farmsClass = new FarmsRegisteredClass(farmer_phonenumber,farmer_County,farmer_Subcounty,farm_Area,farmer_BankAccountName,farmer_ID,land_Acres,farm_Account_Number,emails);
                                reference.child(farmer_ID).setValue(farmsClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
